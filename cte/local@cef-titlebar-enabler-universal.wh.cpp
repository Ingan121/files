...
// @name            Universal CEF/Spotify Titlebar Enabler
...
* Supported CEF versions: 90, 91, 94-101, 102-106, 120, 124-132
    * Versions between the listed versions, and versions before 90, are likely to not work
...
* Spotify notes:
    ...
    * Try toggling hardware acceleration multiple times (both in window menu and in preferences) if you want a proper window icon. It may work on recent-ish versions
*/
// ==/WindhawkModReadme==
