// ==WindhawkMod==
// @id              cef95-titlebar-enabler
// @name            CEF/Spotify Titlebar Enabler for CEF 95
...
* Tested Spotify versions: 1.1.68 to 1.1.88
    * DWM window controls work till 1.1.74 (1.1.75+ broke this by adding Win11 maximize hover menu support)
    * Non-DWM window controls work till 1.1.85
*/
// ==/WindhawkModReadme==
...
BOOL Wh_ModInit() {
    ...
    cef_panel_create_t cef_panel_create = 
        (cef_panel_create_t)GetProcAddress(cefModule, "cef_panel_create_t");
    ...
    Wh_SetFunctionHook((void*)cef_panel_create,
                       (void*)cef_panel_create_hook,
